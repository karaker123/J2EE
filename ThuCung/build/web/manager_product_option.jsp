    ...
    <body style="background:url(video/bann.jpg) fixed;color:white;">
        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div>   
                ...
                <h3 style="color:white;">Danh Sách Bài Đăng Bán Sản Phẩm Thú Cưng Của Thành Viên</h3>
                <table id="danhmuc">
                    <tr>
                        <th>Số Thứ Tự</th>
                        <th>Bài Đăng</th>
                    ...
                    <%
                        int countt = 0;
                        for (Option ct : OptionDAO.getListOption()) {
                            countt++;
                    %>
                    <tr>
                        <td><%=countt%></td>
                        <td><img style="width:100px;height:50px;" src="<%=ct.getOptionImage()%>" >
                            <span><%=ct.getOptionName()%></span>
                        </td>
                        <td><%=ct.getOptionHoten()%></td>
                        <td><%=ct.getCategoryoptionName()%></td>
                        <%
                            if (ct.getOptionStatus() == 0) {
                        %>
                        ...
                        <td><%
                            if (ct.getOptionStatus() == 0) {
                            %>
                            <span style="border: 2px dashed red;"><a style="color: rgba(122,231,0,0.8);font-size:15px;" href="MoHinh.jsp?OptionID=<%=ct.getOptionID()%>"><i class="fas fa-unlock-alt"></i>Đi Duyệt</a></span>
                            <%
                                }
                            %>
                            <span><a href="DuyetBaiOption?command=xoa&OptionID=<%=request.getParameter("OptionID")%>"><i class="fas fa-trash-alt">Xóa</i></a></span></td>
