        ...
        <jsp:include page="header_Admin.jsp" ></jsp:include>
            ...
            <div id="content">
                ...
                <div style="width: 100%; padding: 1rem; box-sizing: border-box;">
                    <h3>Cập Nhật Blog</h3>
                <% blogthucung ct = blogthucungDAO.getChitietblogthucung(Integer.parseInt(request.getParameter("blogID").toString()));  %>
                    <form action="quan-ly-blog" method="post" enctype="multipart/form-data">
                        <table width="95%">
                            <tr><td width="125px" style="float:right;"><b>Tiêu đề<%=error%></b></td>
                                <td width="100%"><input style="width: 100%;" type="text" class="sedang" name="title" value="<%=ct.getBlogthucung_title()%>"></td>
                        </tr>
                     ...
                     <tr>
                            ...
                            <tr><td width="125px" style="float:right;"><b>Nội dung<%=error%></b></td>
                                <td><textarea style="width: 100%;" type="text" name="content" rows="10"><%=ct.getBlogthucung_noidung()%></textarea></td></tr>
                        <tr><td></td><td>
