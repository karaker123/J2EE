...
<html>
    <head>
        ...
        <title>Tạo bài đăng cách nuôi</title>
        <meta charset="UTF-8" />
        ...
        <jsp:include page="header_Admin.jsp" ></jsp:include>
            ...
            <div id="content">
                ...
                <div style="width: 100%; padding: 1rem; box-sizing: border-box;" >
                    <h3>Tạo bài đăng cách nuôi</h3>
                    <form action="quan-ly-cach-nuoi" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="command" value="insert">
                        <input type="hidden" name="cachnuoiID">
                        <table width="100%">
                            <tr>
                                <td width="125px"><b>Tiêu đề<%=error%></b></td>
                                <td width="100%"><input style="width:100%;" type="text" class="sedang" name="title"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td width="125px" style="float:right;"><b>Nội dung<%=error%></b></td>
                                <td width="100%"><textarea style="width: 100%; resize: none;" width="100%" type="text" name="content" rows="10"></textarea>
                                </td>
                            </tr>
                        <tr>
                            <td></td>
