    ...
    <body fixed">
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <div>
                  ...
                  <center><a href="manager_product_option.jsp" style="color: white;font-size: 20px;border: 1px solid white;width: 100px;border-radius: 6px;"><p>Trở Lại</p></a></center>
            </div>
            <div class="a1">
                <div class="a2">
                ...
                <div class="single">
                    ...
                    <div class="as" style="margin-left:3rem;">
                        ...
                        <div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="far fa-caret-square-up"></i><strong>Tiêu Đề</strong><span style="margin-left:167px;"><%=c.getOptionName()%></span> </p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fab fa-acquisitions-incorporated"></i><strong>Thể Loại</strong><span style="margin-left:163px;"><%=c.getCategoryoptionName()%></span></p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fab fa-d-and-d"></i><strong>Nguồn gốc</strong><span style="margin-left:136px;"><%=c.getOptionOrigin()%></p></div>                                                     
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fas fa-address-book"></i><strong>Họ Tên Người Đăng</strong><span style="margin-left:72px;"><%=c.getOptionHoten()%></span></p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fas fa-phone-square"></i><strong>Số Điện Thoại</strong><span style="margin-left:117px;"><%=c.getOptionSdt()%></span></p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px;height: auto"><p style="padding-left:591px;font-size:18px;"><i class="fas fa-compass"></i><strong>Địa Điểm</strong><span style="margin-left:155px;"><%=c.getOptionVitri()%></span></p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fas fa-money-bill"></i><strong>Giá</strong><span style="margin-left:197px;"><%=c.getOptionPrice()%> Triệu VNĐ</span></p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fas fa-money-bill"></i><strong>Giá Cũ</strong><span style="margin-left:169px;"><%=c.getOptionOldPrice()%> Triệu VNĐ</span></p></div>
                            <div style="border: 2px solid #00c6d7;border-top-right-radius: 23px"><p style="padding-left:591px;font-size:18px;"><i class="fab fa-penny-arcade"></i><strong>Tình Trạng</strong><span style="margin-left:132px;"><%=c.getOptionStock()%></span></p></div>
                        </div>
                ...
                <div class="as1" style="border: 2px solid black;height: auto;background-color: #FFECB3" >
                    ...
                    <p style="padding-left: 26px;padding-right:26px;font-size:20px"><%=c.getOptionDescription()%></p>
                    <div class="clearfix"> </div>
                ...
                <div class="clearfix"> </div>
                    ...
                    <div id="fb-root"></div>
                          <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v7.0&appId=260072498392467&autoLogAppEvents=1" nonce="qYV6yRTj"></script>
                    <div style="margin-top: 56px;border: 1px solid white;background: rgba(255,255,255, 0.3);">
                    <div class="fb-comments" data-href="http://localhost:8082/ThuCung/MoHinh.jsp?OptionID=<%=request.getParameter("option_id")%>" data-numposts="5" data-width=""></div>
                    </div>
                            ...
                            <div class="content-top-in" style="width:932px;">
                                ...
                                <div class="col-md-3 md-col" style="margin-top:30px;width: 285px;">
                                    <div  class="col-md" style="background:rgba(0,0,0,0.4)">
                                        <div><i class="fas fa-home" ><%=c.getCategoryoptionName()%></i><span><i style="padding-left: 53px;float: right;color: white;" class="far fa-calendar-alt"><%=c.getOptionNgaydang()%></i></span></div>
                                        <div class="clearfix"></div> 
                                        <a href="singleOption.jsp?OptionID=<%=cc.getOptionID()%>"><img  src="<%=cc.getOptionImage()%>" style="height: 253px;" alt="<%=cc.getOptionName()%>" /></a>	
                                        <div class="top-content">
                                            <h5><a  href="single.jsp?OptionID=<%=cc.getOptionID()%>"><%=cc.getOptionName()%></a></h5>
                                            <h5 style="padding: 0px;margin-top: -9px;"><i class="fas fa-compass" ><%=cc.getOptionVitri()%></i></h5>
                                            <h5 style="padding: 0px;margin-top: 4px;"><i class="fab fa-laravel" style="padding: 0px;margin-top: -9px;"><%=cc.getOptionOrigin()%></i></h5>
                                            <%
                                                Users users = null;
                        ...
                        <div class="content-top">
                            ...
                            <div class="content-top-in">
                                ...
                                <div class="col-md-3 md-col" style="margin-top:30px;">
                                    <div  class="col-md" style="background:rgba(0,0,0,0.4)">
                                        <div><i class="fas fa-home" ><%=c2.getCategoryoptionName()%></i><span><i style="padding-left: 53px;float: right;color: white;" class="far fa-calendar-alt"><%=c2.getOptionNgaydang()%></i></span></div>
                                        <div class="clearfix"></div> 
                                        <a href="singleOption.jsp?OptionID=<%=c2.getOptionID()%>"><img  src="<%=c2.getOptionImage()%>" style="height: 253px;" alt="<%=c2.getOptionName()%>" /></a>	
                                        <div class="top-content">
                                            <h5><a  href="single.jsp?OptionID=<%=c2.getOptionID()%>"><%=c2.getOptionName()%></a></h5>
                                            <h5 style="padding: 0px;margin-top: -9px;"><i class="fas fa-compass" ><%=c2.getOptionVitri()%></i></h5>
                                            <h5 style="padding: 0px;margin-top: 4px;"><i class="fab fa-laravel" style="padding: 0px;margin-top: -9px;"><%=c2.getOptionOrigin()%></i></h5>
                                            <%
                                                Users users = null;
                                                if (session.getAttribute("user") != null) {
                                                    users = (Users) session.getAttribute("user");
                                            ...
                                            <div class="white">
                                                <%
                                                    if (!cart.getCartItems().containsKey(c.getOptionID())) {
                                                %>
                                                <a href="#" id="luuthongtinchothue" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">Đặt Hàng</a>
                                                <%
                                                } else {
                                                %>
                                                <a href="#" style="cursor:unset;background:black;" id="luuthongtin" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">Đã Đặt</a>
                ...
                <div>
                    <div id="dialogCont" class="dlg-container">
                        ...
                        <div class="dlg-footer">
                            <a href="DuyetBaiOption?command=duyet&OptionID=<%=request.getParameter("OptionID")%>" style="margin-left: 4px;" ><i class="fas fa-user-times" style="margin-left:2px;">Duyệt</i></a>
                            <a href="DuyetBaiOption?command=xoa&OptionID=<%=request.getParameter("OptionID")%>" style="margin-left: 56px;" ><i class="fas fa-times-circle">Hủy Bỏ</i></a>
                        </div>
                    </div>
                </div>
                <style>
